(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key use-package smartparens nlinum-relative helm expand-region evil-surround evil-numbers evil-mc evil-escape elpy company-quickhelp company-auctex color-theme-sanityinc-tomorrow avy auctex-latexmk atom-one-dark-theme))))
(custom-set-faces
