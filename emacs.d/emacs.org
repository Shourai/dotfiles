...
Add LatexMk support to AUCTeX
    #+BEGIN_SRC emacs-lisp
        ...
        (add-hook 'LaTeX-mode-hook (lambda ()
                             (push '("latexmk" "latexmk -pdflatex='pdflatex 
                                    -interaction=nonstopmode -file-line-error -synctex=1' -pdf %s" 
                                    TeX-run-TeX nil t :help "Run latexmk on file") TeX-command-list)))
