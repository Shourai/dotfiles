...
* Visual settings
  ...
  #+END_SRC
    ...
    (setq display-time-24hr-format  t
          ...
          display-time-format "%H:%M - %a %d %B %Y"
...
***  Relative line numbering
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (set-face-attribute 'linum nil :height 120) ;; Fix for large font size
       (setq nlinum-relative-redisplay-delay 0.5))
     #+END_SRC
     
** Theme
   [[https://github.com/bbatsov/solarized-emacs][Solarized theme]]  
   Light color/foreground: `#fdf6e3`  
   Dark color/foreground: `#002b36`
   #+BEGIN_SRC emacs-lisp
   ...
   ;             (:line-width 1 :color "#002b36")
   ;             :foreground "#002b36" :background "#657b83")))))
    )
   #+END_SRC
